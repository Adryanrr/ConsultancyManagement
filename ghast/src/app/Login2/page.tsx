            ...
            <div className="flex flex-col lg:flex-row items-center bg-white rounded-xl shadow-lg max-w-screen-lg w-full">
                ...
                <div className="flex flex-col items-center justify-center p-8 lg:px-12 rounded-xl w-full lg:w-[50%] space-y-6">
                    ...
                    <div className="flex flex-col items-center gap-4 select-none pointer-events-none">
                        ...
                        <p className="hidden lg:block">_______________________________________</p>
                        
                        {/* Gengar para dispositivos móveis */}
                        <div className="flex mt-4 mb-8 lg:hidden">
                            <Image src="/assets/gengarMobile.svg" alt="Gengar" width={300} height={300} />
                        </div>
                    </div>

                    {/* Mensagem de boas-vindas */}
                    <div className="text-center">
                        <h1 className="text-2xl lg:text-3xl font-bold">Bem-vindo de volta!</h1>
                        <p className="text-gray-600 mt-2 text-sm lg:text-base">Para acessar a plataforma, por favor realize o login.</p>
                    </div>
...
function ForgotPasswordLink() {
    return (
        <div className="text-center mt-4">
            <a href="#" className="text-blue-700 hover:underline text-sm lg:text-base">Esqueceu a senha?</a>
        </div>
    );
}
