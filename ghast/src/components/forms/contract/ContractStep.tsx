  ...
  return (
    <FormStep onNext={onNext} onBack={onBack} isLastStep={isLastStep} currentStep={currentStep}>
      <div className="space-y-4 max-h-[500px]">
        <ScrollArea className="h-[400px] w-full rounded-md border p-6 bg-white dark:bg-darkMain dark:text-white">
      ...
      <div className="space-y-4">
        <div className="p-4 rounded-md border-gray-300 dark:bg-darkMain">
          ...
          <h3 className="font-semibold">CONTRATANTE: <span className="font-normal">{formData.companyName}</span></h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">CNPJ Nº 00.111.422/0001-69</p>
          <h3 className="font-semibold mt-2">CONTRATADO: <span className="font-normal">GHAST CONSULTORIA E GESTÃO</span></h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">CNPJ Nº 15.209.224/0001-34</p>
          <h3 className="font-semibold mt-2">VALOR DO CONTRATO: <span className="font-normal">R$ 122.000,00</span></h3>
